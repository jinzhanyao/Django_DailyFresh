...
class LoginView(View):
    ...
    def post(self, request):
        ...
        print("_get_backends(return_tuples=True)---", _get_backends(return_tuples=True))
        print("settings.AUTHENTICATION_BACKENDS---", settings.AUTHENTICATION_BACKENDS)
        # print("import_string(path)()---", import_string(path)())
